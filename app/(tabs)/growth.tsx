...
const styles = StyleSheet.create({
  ...
  aiCard:{backgroundColor:'#FFFFFF',borderRadius:16,padding:20,marginBottom:12,shadowColor:'#000',shadowOffset:{width:0,height:1},shadowOpacity:0.05,shadowRadius:4,elevation:2,minHeight:100},
  ...
  aiCommentContainer:{},
  aiTextFree:{fontSize:14,color:'#333',lineHeight:22,marginBottom:8,flexShrink:1},
  blurContainer:{minHeight:80,position:'relative',marginTop:8},
  dummyText:{fontSize:13,color:'#DDD',lineHeight:20,flexShrink:1},
  ...
  aiTextPaid:{fontSize:14,color:'#333',lineHeight:22,flexShrink:1},
  skyTipBox:{backgroundColor:'#F0F8FF',borderRadius:12,padding:12,marginTop:12,minHeight:60},
