...
const styles = StyleSheet.create({
  ...
  aiCommentCard: { marginTop: 16, width: '100%', paddingVertical: 16, paddingHorizontal: 16, backgroundColor: '#F8F9FA', borderRadius: 12, minHeight: 80 },
  ...
  aiCommentText: { fontSize: 13, color: '#555', lineHeight: 20, flexShrink: 1 },
